...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        // 隐藏不需要的控件
        View homeRecView = findViewById(R.id.llHomeRec);
        View searchViewView = findViewById(R.id.llSearchView);
        View parseWebView = findViewById(R.id.llParseWebVew);
        if (homeRecView != null) homeRecView.setVisibility(View.GONE);
        if (searchViewView != null) searchViewView.setVisibility(View.GONE);
        if (parseWebView != null) parseWebView.setVisibility(View.GONE);
